...
cfg.PREPROC = CN()
cfg.PREPROC.DETECTOR_CKPT = 'checkpoints/yolov8x.pt'
cfg.PREPROC.DETECTOR_IMGSZ = 640
cfg.PREPROC.DETECTOR_SCALE = 1.0
cfg.PREPROC.POSE_BACKEND = 'vitpose'
cfg.PREPROC.POSE_MODEL = None
cfg.PREPROC.MIN_TRACK_FRAMES = 30
cfg.PREPROC.FEATURE_BATCH_SIZE = 32
